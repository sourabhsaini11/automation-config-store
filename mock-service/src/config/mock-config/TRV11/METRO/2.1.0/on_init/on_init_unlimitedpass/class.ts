...
import { onInitUnlimitedPassGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockOnInitMetroUnlimitedPass210Class extends MockAction {
  ...
  name(): string {
    return "on_init_METRO_UNLIMITEDPASS_210";
  }
  get description(): string {
    return "Mock for on_init_METRO_UNLIMITEDPASS_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onInitUnlimitedPassGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
