...
export class MockOnSelect1PersonalLoan3Class extends MockAction {
    ...
    name(): string { return "on_select_1_personal_loan"; }
    get description(): string { return "Mock for on_select_1 personal loan"; }
