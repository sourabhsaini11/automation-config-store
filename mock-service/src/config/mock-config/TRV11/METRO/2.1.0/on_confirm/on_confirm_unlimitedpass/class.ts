...
import { onConfirmUnlimitedPassGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockOnConfirmMetroUnlimitedPass210Class extends MockAction {
  ...
  name(): string {
    return "on_confirm_METRO_UNLIMITEDPASS_210";
  }
  get description(): string {
    return "Mock for on_confirm_METRO_UNLIMITEDPASS_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onConfirmUnlimitedPassGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
