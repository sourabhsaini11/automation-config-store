...
import { onSelectUnlimitedPassGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockOnSelectMetroUnlimitedPass210Class extends MockAction {
  ...
  name(): string {
    return "on_select_METRO_UNLIMITEDPASS_210";
  }
  get description(): string {
    return "Mock for on_select_METRO_UNLIMITEDPASS_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onSelectUnlimitedPassGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
