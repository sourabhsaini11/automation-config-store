...
import { confirmUnlimitedPassGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockConfirmMetroUnlimitedPass210Class extends MockAction {
  ...
  name(): string {
    return "confirm_METRO_UNLIMITEDPASS_210";
  }
  get description(): string {
    return "Mock for confirm_METRO_UNLIMITEDPASS_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return confirmUnlimitedPassGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
