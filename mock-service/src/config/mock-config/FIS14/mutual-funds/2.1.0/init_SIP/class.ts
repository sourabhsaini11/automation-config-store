...
import { initSIPDefaultGenerator } from "./generator";

export class MockInitSIPClass extends MockAction {
  ...
  get description(): string {
    return "Mock for mutual funds init for SIP Creation New Folio";
  }

  async generator(existingPayload: any, sessionData: any): Promise<any> {
    return initSIPDefaultGenerator(existingPayload, sessionData);
  }
