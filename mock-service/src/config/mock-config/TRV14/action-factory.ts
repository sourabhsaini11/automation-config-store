...
import { MockOnStatusDefaultClass, MockUnsolicatedOnStatusDefaultClass } from "./2.0.0/on_status/class";
...
const registry = {
	...
	on_status_unsoliciated: MockUnsolicatedOnStatusDefaultClass,
