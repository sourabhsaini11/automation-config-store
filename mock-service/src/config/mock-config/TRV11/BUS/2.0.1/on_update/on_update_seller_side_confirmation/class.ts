...
import { onUpdateGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockOnUpdateBus201Class extends MockAction {
  ...
  name(): string {
    return "on_update_BUS_201";
  }
  get description(): string {
    return "Mock for on_update_BUS_201";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onUpdateGenerator(existingPayload, sessionData);
  }
  async validate(
  targetPayload: any,
